...
export function computeSVY21(lat, lon) {
...
export function computeLatLon(E, N) {
    var Nprime = N - oN
    var Mo = calcM(oLat)
    ...
    var n3 = n2 * n
    var n4 = n2 * n2
    var G = a * (1 - n) * (1 - n2) * (1 + (9 * n2 / 4) + (225 * n4 / 64)) * (Math.PI / 180)
